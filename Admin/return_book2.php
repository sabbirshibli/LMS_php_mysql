                ...
                <div class="row" style="min-height:500px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
							<center><h4>Books Returning Wizard</h4></center>
							<br>
								<form name="form1" action="" method="post">
									<table class="table">
										<tr>
											<td><input type="text" name="t1" placeholder="Enter Reg No." required class="form-control"></td>
											<td><input type="submit" name="submit1" value="Find Issues Info" class="form-control btn btn-default" style="background-color: blue; color: white"></td>
										</tr>
									</table>
								</form>
								...
								if(isset($_POST["submit1"])) {
									...
									<table class="table table-bordered">
										...
										<tr>
											<td>
												<input type="submit" name="submit2" value="Return Book" class="form-control btn btn-default" style="background-color: blue; color: white">
											</td>
										</tr>
									</table>
									</form>
								...
								if(isset($_POST["submit2"])) {
									mysqli_query($connection, "DELETE FROM issue_book where student_reg='$_POST[student_reg]'");
									?>
